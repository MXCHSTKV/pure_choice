...
const Product = (props) => {
    ...
    return (
        <div className="relative w-44 sm:w-48 shadow-sm h-72 mx-auto my-2 md:my-6  bg-white cursor-pointer rounded-xl overflow-hidden">
            ...
            <div className="text-md ml-2 mr-2 mt-2 font-semibold max-h-12 overflow-hidden ">{props.item}</div>
